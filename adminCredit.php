...
<?php
    ...
    {
        $uid_php_err = $cardNum_php_err = $cardName_php_err = $expMonth_php_err = $account_type_php_err = '';
...
?>
    ...
    <div class="banner">
        <a class="bannerText"></a>
        <a class="bannerText" href="adminCredit.php">Credit</a>
        <a class="bannerText" href="adminShipping.php">Shipping</a>
        <a class="bannerText" href="adminUsers.php">Users</a>
    </div>

    <div class="banner">
        <a class="bannerText"></a>
        <a class="bannerText" href="adminTransaction.php">Transaction</a>
        <a class="bannerText" href="adminProducts.php">Products</a>
        <a class="bannerText" href="adminPurchase.php">Purchases</a>
    </div>
    ...
    <form action='<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>' method='post'>
		...
		<input type="text" name="uid" id="uid" maxlength="11" value='<?php echo $uid ?>'/>
		...
		<button type="submit" id="adminCreditSubmit">Change credit card information</button>
